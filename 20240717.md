...
The following two graphs compare the performance of the baseline QEMU with the new patch version of QEMU.  We only show data for `vle8.v`, but the graphs for `vse8.v` are very similar.
